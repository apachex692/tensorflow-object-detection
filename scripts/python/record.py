...
#
# CLA: image_path, xml_path, label_map, output_path
#
...
def main(argv) -> int:
    ...
    groups = [data(file, dataframe_group.get_group(metadata)) for file, metadata in zip(
        dataframe_group.groups.keys(),
        dataframe_group.groups
    )]
